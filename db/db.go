...
import (
	...
	"github.com/18F/aws-broker/services/opensearchservice"
...
func InternalDBInit(dbConfig *common.DBConfig) (*gorm.DB, error) {
	...
	// db.LogMode(true)
	// Automigrate!
	db.AutoMigrate(&rds.RDSInstance{}, &redis.RedisInstance{}, &opensearchservice.Instance{}, &base.Instance{}) // Add all your models here to help setup the database tables
